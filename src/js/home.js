export default (function () {
	function createSideBar() {
		...
		<div class="side-middle">
			<button class="side-row">
				...
				<span class="top2px">Add Task</span>
			</button>
			<button class="side-row tab">
				...
				<span class="top2px">Random Todos</span>
			</button>
			<button class="side-row tab">
				<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
					fill="#8b5cf6">
			...
			<button class="side-row tab">
				...
				<span class="top2px">Tomorrow</span>
			</button>
			<button class="side-row tab">
				<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
					fill="#e8eaed">
				...
				<span class="top2px">Week</span>
			</button>
			<button class="side-row tab active-tab">
				<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
					fill="#e8eaed">
					<path
			...
			<button class="side-row tab">
				...
				<span class="top2px">Completed Tasks</span>
			</button>
		</div>
		<hr>
		<div class="side-bottom">
			<div class="side-bottom-head">
				<span class="side-bottom-right">My Projects</span>
			...
			<div class="projects">
				<button class="side-row tab top2px"># Chore</button>
				<button class="side-row tab top2px"># Study</button>
				<button class="side-row tab top2px"># Gym</button>
			</div>
		</div>
		`;
	...
	function renderSideBar() {
		const sideBarMarkup = createSideBar();
